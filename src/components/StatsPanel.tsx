...
const StatsCard: React.FC<{ value: string; label: string; icon: React.ReactNode }> = ({ value, label, icon }) => {
  return (
...
const ResearchCard: React.FC<{ title: string; date: string; arrow?: boolean }> = ({ title, date, arrow }) => {
  return (
