...
/**
 * @typedef {Object} ConsultantCardProps
...
const ConsultantCard = ({ name, specialty, image, available = true }) => {
  return (
...
const AppointmentCard = ({ type, date, time, doctor, isVideo = false }) => {
  return (
